...
class FolderAdapter extends BaseAdapter {
    ...
    public View getView( int position, View convertView, ViewGroup parent ) {
        if( convertView == null ) {
            int list_item_resid = ( Build.VERSION.SDK_INT >= 11 ) ? android.R.layout
                    .simple_list_item_activated_2 : android.R.layout.simple_list_item_2;
        ...
        if( info.isFolder ) {
            ...
            String modDate = DateFormat.getMediumDateFormat( mContext ).format( info.modifiedTime
    ...
    private String getName( DbxFileInfo info ) {
        return Util.stripExtension( "data_ser", info.path.getName() );
    }
