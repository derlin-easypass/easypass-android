...
public class JsonManager {
     ...
     * @throws java.io.IOException
     */
    public Object deserialize( String algo, String filepath, String password,
                               Type type ) throws WrongCredentialsException, IOException {
        return this.deserialize( algo, new FileInputStream( filepath ), password, type );
    }// end deserialize
     ...
     * @throws java.io.IOException
     */
    public Object deserialize( String algo, InputStream stream, String password,
                               Type type ) throws WrongCredentialsException, IOException {
